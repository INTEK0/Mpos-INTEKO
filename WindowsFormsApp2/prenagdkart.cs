...
{
    public partial class prenagdkart : DevExpress.XtraEditors.XtraForm
    {
        ...
        public prenagdkart(decimal a, POS_LAYOUT_NEW frm)
        {
            InitializeComponent();
            h = a;
            frm1 = frm;
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                else
                {
                    ...
                    if ((n_ + k_) < Convert.ToDecimal(tTotal.Text))
                    {
                        ...
                        frm1.gelen_data_negd_pos_pre(n_, k_, n_);
                        this.Close();
                    }
                    else
                    {
                        XtraMessageBox.Show("ÖDƏNİLƏN MƏBLƏĞ COKTUR");
                    }
        ...
        void Sales()
        {
            ...
            {
                frm1.gelen_data_negd_pos_pre(cash, card, total, _odenilenNagd, _qaliq, chClinicModul.Checked);
                this.Close();
            }
            else
            {
