...
{
    public partial class QAIMESATISLAYOUTSA : DevExpress.XtraEditors.XtraForm
    {
        private readonly RibbonForm1 frm1;
        ...
        public QAIMESATISLAYOUTSA(int _userid, RibbonForm1 frm_)
        {
            InitializeComponent();
            _g_user_id = _userid;
            frm1 = frm_;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            {
                                gaime_ = textEdit17.Text.ToString();
                            }
                            ...
                            {
                                mebleg_ = textEdit1.Text.ToString();
                            }
                     ...
                     textEdit5.Text.ToString(), gaime_,
                     mebleg_, Convert.ToDateTime(dateEdit1.Text), radio.Trim(), textEdit3.Text.ToString(), _g_user_id, edv_siz, ed, Convert.ToInt32(labelControl9.Text))
                                ;
                            ...
                            if (ret > 0)
                            {
                                ...
                                {
                                    gaime_nomre = textEdit17.Text.ToString();
                                }
                                ...
                                {
                                    string a = textEdit1.Text.ToString();
                                    string b = a.Replace('.', ',');
                                    mebleg = Convert.ToDecimal(b);
                                }

                                string an_galig = anbargalig.Replace('.', ',');
                                decimal anbar_ga = Convert.ToDecimal(an_galig);

                                string mig = textEdit8.Text.ToString();
                            ...
                            ,
                            Convert.ToInt32(mal_alisi_details_id), Convert.ToInt32(lookUpEdit1.EditValue.ToString())
                           ...
                           textEdit1.Text.ToString(), textEdit11.Text.ToString()
                            );
        ...
        private void button21_Click(object sender, EventArgs e)
        {
            ...
            XtraMessageBox.Show("UĞURLA SİLİNDİ");
            gridControl1.DataSource = null;
        }
