namespace WindowsFormsApp2.Helpers.Messages
{
    public static class CommonData
    {
        ...
        public static readonly string SUCCESS_OPEN_SHIFT = "NÖVBƏ UĞURLA AÇILDI";
        public static readonly string SUCCESS_SHIFT_STATUS = "NÖVBƏ ARTIQ AÇIQDIR";
        public static readonly string SUCCESS_CLOSE_SHIFT = "GÜNSONU (Z) HESABATI UĞURLA ÇIXARILDI";
